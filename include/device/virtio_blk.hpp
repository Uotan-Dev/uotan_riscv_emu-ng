...
enum VirtioReg : uint32_t {
    VIRTIO_MagicValue = 0x000 >> 2,
    VIRTIO_Version = 0x004 >> 2,
    VIRTIO_DeviceID = 0x008 >> 2,
    VIRTIO_VendorID = 0x00c >> 2,
    VIRTIO_DeviceFeatures = 0x010 >> 2,
    VIRTIO_DeviceFeaturesSel = 0x014 >> 2,
    VIRTIO_DriverFeatures = 0x020 >> 2,
    VIRTIO_DriverFeaturesSel = 0x024 >> 2,
    VIRTIO_QueueSel = 0x030 >> 2,
    VIRTIO_QueueNumMax = 0x034 >> 2,
    VIRTIO_QueueNum = 0x038 >> 2,
    VIRTIO_QueueReady = 0x044 >> 2,
    VIRTIO_QueueNotify = 0x050 >> 2,
    VIRTIO_InterruptStatus = 0x060 >> 2,
    VIRTIO_InterruptACK = 0x064 >> 2,
    VIRTIO_Status = 0x070 >> 2,
    VIRTIO_QueueDescLow = 0x080 >> 2,
    VIRTIO_QueueDescHigh = 0x084 >> 2,
    VIRTIO_QueueDriverLow = 0x090 >> 2,
    VIRTIO_QueueDriverHigh = 0x094 >> 2,
    VIRTIO_QueueDeviceLow = 0x0a0 >> 2,
    VIRTIO_QueueDeviceHigh = 0x0a4 >> 2,
    VIRTIO_ConfigGeneration = 0x0fc >> 2,
    VIRTIO_Config = 0x100 >> 2,
};
